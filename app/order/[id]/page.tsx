      ...
      >
        <section className="mb-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <Badge variant={order.status === 3 ? "secondary" : "default"} className="text-lg">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <p className="dark:text-gray-300">
              <strong>Status:</strong> {statusMap[order.status] || "Unknown"}
            </p>
          </div>
          <div>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-4">
            {order.cartItems.map((item) => (
              <div key={item.id} className="flex justify-between items-center py-2 border-b last:border-b-0 dark:border-gray-600">
                <div>
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={() => setShowReviewModal(false)} className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                  <X className="h-6 w-6" />
                </button>
              </div>
              <p className="mb-4 text-gray-600 dark:text-gray-300">Share your thoughts about the product and your overall experience.</p>
